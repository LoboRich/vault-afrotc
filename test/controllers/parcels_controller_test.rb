...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference("Parcel.count") do
      post parcels_url, params: { parcel: { block: @parcel.block, lot: @parcel.lot, status: @parcel.status } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { block: @parcel.block, lot: @parcel.lot, status: @parcel.status } }
