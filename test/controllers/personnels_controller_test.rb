...
class PersonnelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personnel" do
    assert_difference("Personnel.count") do
      post personnels_url, params: { personnel: { branch_location: @personnel.branch_location, contact_number: @personnel.contact_number, given_name: @personnel.given_name, last_name: @personnel.last_name, role: @personnel.role, user_id: @personnel.user_id } }
    end
  ...
  test "should update personnel" do
    patch personnel_url(@personnel), params: { personnel: { branch_location: @personnel.branch_location, contact_number: @personnel.contact_number, given_name: @personnel.given_name, last_name: @personnel.last_name, role: @personnel.role, user_id: @personnel.user_id } }
