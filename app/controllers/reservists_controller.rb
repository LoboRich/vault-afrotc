class ReservistsController < ApplicationController
  ...
  private
    ...
    def reservist_params
      params.require(:reservist).permit(:role, :rank, :last_name, :first_name, :middle_name, :branch_of_service, :afpsn, :primary_afsc, :duty_afsc, :other_skills, :source_of_enlistment, :soe_authority, :soe_date_of_enlistment, :soe_initial_rank, :source_of_commission, :soc_authority, :soc_date_of_enlistment, :soc_initial_rank, :reservist_classification, :classification_authority, :date_of_classification, :reserve_unit_assignment, :date_assigned, :unit_capability, :present_designation, :mobilization_center, :street_address, :city, :province, :region, :zip_code, :date_of_birth, :place_of_birth, :age, :sex, :marital_status, :religion, :ethnic_group, :blood_type, :eye_color, :hair_color, :complexion, :identifying_marks, :height_cm, :weight_kg, :email, :residence_tel, :office_tel, :mobile_nr, :tin, :sss_number, :gsis_number, :philhealth_number, :pagibig_number, :dialects_spoken, :latitude, :longitude, :lat, :long, :location, :is_active,service_assignments: [:position, :unit, :authority, :from, :to], service_rank_adjustments: [:rank, :effective_date, :authority], active_service: [:type, :purpose, :authority, :from, :to], basic_primary: [:school, :from, :to, :grade], basic_secondary: [:school, :from, :to, :grade], basic_tertiary: [:school, :from, :to, :grade], basic_rotc: [:school, :from, :to, :grade], advance_rotc: [:school, :from, :to, :grade], pre_commission: [:school, :from, :to, :grade], post_graduate: [:post_graduate, :school, :from, :to, :grade], board_eligibility: [:license_type, :exam_date, :license_nr, :board_rating], military_schooling: [:courses, :school, :from, :to, :grade], military_training: [:courses, :school, :from, :to, :grade], seminar: [:courses, :school, :from, :to, :grade], work_positions: [:position, :company, :from, :to, :business_address], military_awards: [:award_type, :achievements, :authority], other_awards: [:award_type, :achievements, :authority], commendations: [:date, :given_by], certificates: [:date_awarded, :given_by], dependents: [:name, :relationship, :birth_date], tariff_sizes: [:built, :combat_boots, :bdu, :cap, :tshirt, :short, :dress_shoes], contact_persons: [:name, :address, :relationship, :contact_number])
    end
end
