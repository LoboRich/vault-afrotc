class ReservistsController < ApplicationController
  ...
  private
    ...
    def reservist_params
      ...
      service_assignments: {}, service_rank_adjustments: {}, active_service: {}, basic_primary: {},basic_secondary: {}, basic_tertiary: {}, basic_rotc: {}, advance_rotc: {}, pre_commission: {}, post_graduate: [:school, :degree, :year_graduated], board_eligibility: [:license_type, :exam_date, :license_nr, :board_rating], military_schooling: {}, military_training: {}, seminar: {}, work_positions: {}, military_awards: {}, other_awards: {}, commendations: {}, certificates: {}, dependents: {}, tariff_sizes: {}, contact_persons: {})
    end
end
