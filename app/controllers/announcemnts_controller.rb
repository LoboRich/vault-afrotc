  ...
  def create
    ...
    respond_to do |format|
      if @announcemnt.save
        ...
        # Reservist.find_each do |reservist|
        #   AnnouncementMailer
        #     .new_announcement(reservist, @announcement)
        #     .deliver_later
        # end
        AnnouncementMailer.new_announcement({email: "fuentebelladaroel@gmail.com"}, @announcemnt).deliver_now
